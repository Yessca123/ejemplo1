...
<nav class="nav-page" id='barraNavegacionPrincipal'>
    ...
    <ul class="nav-menuWrap">
        ...
        <li class="nav-menuItem"><a href="alumnos.php">Alumnos</a></li>
        <li class="nav-menuItem"><a href="profesores.php">Profesores</a></li>
        <li class="nav-menuItem"><a href="usuarios.php">Usuarios</a></li>
        <li class="nav-menuItem"><a href="colegio.php">Colegio</a></li>
    </ul>
...
<nav class="mobile-menu hidden" id='mobile-menu'>
    ...
    <ul class="nav-menuWrap nav-menuWrapMobile">
        ...
        <li class="nav-menuItem mobile-item"><a href="alumnos.php">Alumnos</a></li>
        <li class="nav-menuItem mobile-item"><a href="profesores.php">Profesores</a></li>
        <li class="nav-menuItem mobile-item"><a href="usuarios.php">Usuarios</a></li>
        <li class="nav-menuItem mobile-item"><a href="colegio.php">Colegio</a></li>
    </ul>
