...
<html>
    <head>
        ...
        <link rel="stylesheet" href="modules/materias/views/theme/css/signatures.css">
        ...
        <script src="modules/materias/views/theme/js/classes/Signatures_table.js"></script>
        <script src="modules/materias/views/theme/js/classes/Signature.js"></script>
        <script src="views/theme/js/classes/Status_btn.js"></script>
        <script src="modules/materias/views/theme/js/signatures.js"></script>
    ...
    <body>
    	...
    	<div class="main-container">
        	...
        	<section class="content">
        		...
        		<?php
            		require_once('modules/materias/views/theme/inc/c_signatures.php');
    			?>
