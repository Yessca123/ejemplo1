...
<html>
    <head>
        ...
        <link rel="stylesheet" href="modules/usuarios/views/theme/css/main_page.css">
        <link rel="stylesheet" type="text/css" href="views/theme/css/all.min.css">  
        <link rel="stylesheet" type="text/css" href="views/theme/css/responsive.css">
    	...
    	<div class="main-container">
        	...
        	<section class="content">
        		...
        		<?php
            		...
            		require_once('modules/usuarios/views/theme/inc/c_main.php');
