...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="modules/profesores/views/theme/css/change_password.css">	
		...
		<script src="modules/profesores/views/theme/js/changePassword.js"></script>
		...
		<div class="main-container">
		    ...
		    <section class="content">
		    	...
		    	<?php
		        	...
		        	require_once('modules/profesores/views/theme/inc/c_change_password.php');
